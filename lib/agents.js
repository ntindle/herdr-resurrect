...
const KNOWN = {
  ...
  copilot: { resume: '--resume {value}', continue: '--continue' },
  cursor: { resume: '--resume={value}', continue: '' },
};

// Agents whose CLI binary differs from herdr's agent name.
const BIN = { cursor: 'cursor-agent' };
